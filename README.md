The react js application is using contextapi and store that state, we can add transactions and we can delete transactions and the balance, income and expense will be calculated realtime. 
